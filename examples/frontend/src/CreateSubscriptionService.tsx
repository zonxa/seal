...
export function CreateService() {
    ...
    signAndExecute(
      ...
      },
      {
        onSuccess: async (result) => {
          ...
          if (createdObjectId) {
            window.open(`${window.location.origin}/subscription-example/admin/service/${createdObjectId}`, '_blank');
          }
        },
      },
    );  
  ...
  return (
    <Card className="max-w-xs">
      <h3 style={{ marginBottom: "1rem" }}>Admin View: Subscription</h3>
      ...
      <Flex direction="row" gap="2" justify="start">
        ...
        <Button size="3" onClick={handleViewAll}>View All Created Services</Button>
      </Flex>
      </Flex>
    </Card>
  );
