...
Apps can retrieve a list of allowlisted Seal key Testnet servers using the `getAllowlistedKeyServers()` function, or use a custom app-defined or user-defined list.
